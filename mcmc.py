...
def run_mcmc(
    ...
    output_filename = "/home/inikolic/projects/UVLF_FMs/run_speed/runs_may/all_ang/"
    #if initialized
    mult_params_fid = {
        "use_MPI": True,
...
if __name__ == "__main__":
    ...
    run_mcmc(likelihoods, params, priors=priors, covariance=False, diagonal=False, realistic_Nz=True, M_knee=False)
